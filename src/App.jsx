        ...
        <div className="followup-list">
          <div className="lead-card">
            ...
            <div className="lead-bottom" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              ...
              <div className="lead-actions"><i className="fa-brands fa-whatsapp icon-action"></i><i className="fa-solid fa-phone icon-action"></i><i className="fa-solid fa-envelope icon-action"></i><i className="fa-solid fa-clock icon-action"></i></div>
            </div>
          </div>
        </div>
      </div>
    ...
    <div className="app">
      <aside className="sidebar">
        ...
        <div className="nav-block">
          <div className="nav-item" onClick={() => setCurrentView("Dashboard")}>Dashboard</div>
          <div className="nav-item" onClick={() => setCurrentView("Leads")}>Leads</div>
          <div className="nav-item" onClick={() => setCurrentView("Follow-ups")}>Follow-ups</div>
          <div className="nav-item" onClick={() => setCurrentView("Sales Analysis")}>Sales Analysis</div>
          <div className="nav-item" onClick={() => setCurrentView("Settings")}>Settings</div>
          <div className="nav-item" onClick={() => setCurrentView("Help Center")}>Help Center</div>
        </div>
